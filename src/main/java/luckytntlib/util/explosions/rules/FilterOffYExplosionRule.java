...
/**
 * An {@link ExplosionRule} that only applies to blocks within a specified range of offset on the y-axis
 */
public class FilterOffYExplosionRule implements ExplosionRule {
	
	public static final ResourceLocation RESOURCE_LOCATION = new ResourceLocation(LuckyTNTLib.MODID, "filter_offy");

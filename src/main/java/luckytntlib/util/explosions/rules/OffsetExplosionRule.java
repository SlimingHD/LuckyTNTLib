...
/**
 * An {@link ExplosionRule} that changes the position and block being checked to determine whether to apply by a specified offset
 */
public class OffsetExplosionRule implements ExplosionRule {

	public static final ResourceLocation RESOURCE_LOCATION = new ResourceLocation(LuckyTNTLib.MODID, "offset");
